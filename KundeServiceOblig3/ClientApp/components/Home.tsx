...
export class Home extends React.Component<RouteComponentProps<{}>, {}> {
    public render() {
        return <div>
            ...
            <h4>Teknologier</h4>
            <p>Dette prosjektet er en obligatorisk oppgave i faget ITPE3200 - Webapplikasjoner. F&#248;lgende teknoliger er brukt</p>
            <ul>
                ...
                <li><a href='https://webpack.github.io/'>Webpack</a> for bygging og bundling av klient-ressurser</li>
